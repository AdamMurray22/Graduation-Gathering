...
class _ScreenHolderState extends State<ScreenHolder> {
  ...
  _loadMainScreen(AuthToken authToken) async
  {
    ...
    Future<Connections> futureConnections = GetConnections().send(authToken);
    ...
    _screen = MainScreen(authToken: authToken, profile: profile, academicStructure: structure, gradZones: zones, connections: connections);
  }
}
